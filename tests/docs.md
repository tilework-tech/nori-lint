...
- Helper functions create SKILL.md fixtures that target specific rule behaviors: valid skills (small, well-formed), oversized skills (exceeding 150-line limit), skills missing `<required>` tags, skills with unclosed tags, and skills with redundant title headings
